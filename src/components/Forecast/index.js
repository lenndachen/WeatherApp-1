...
const Forecast = ({ forecast, apiData }) => (
    <div className="forecast">
    <h2 className="foreHeader">The 5-day forecast is: </h2>
        
        <div className="foreDay1">For {forecast[0]}: <br/> 
            High: {forecast[1]} {'\u00b0'}F<br/>
            Low: {forecast[1]} {'\u00b0'}F<br/>
            Conditions: <br/>
                <img className="weatherIcon" src={
                    "http://openweathermap.org/img/wn/" + forecast[3] + "@2x.png"
                    } alt="weather icon"></img><br/>
                {forecast[2]}</div>
        <div className="foreDay2">For {forecast[5]}: <br/> 
            High: {forecast[6]} {'\u00b0'}F<br/>
            Low: {forecast[6]} {'\u00b0'}F<br/>
            Conditions: <br/>
                <img className="weatherIcon" src={
                    "http://openweathermap.org/img/wn/" + forecast[8] + "@2x.png"
                    } alt="weather icon"></img><br/>
                {forecast[7]}</div>
        <div className="foreDay3">For {forecast[10]}: <br/> 
            High: {forecast[11]} {'\u00b0'}F<br/>
            Low: {forecast[11]} {'\u00b0'}F<br/>
            Conditions: <br/>
                <img className="weatherIcon" src={
                    "http://openweathermap.org/img/wn/" + forecast[13] + "@2x.png"
                    } alt="weather icon"></img><br/>
                {forecast[12]}</div>
        <div className="foreDay4">For {forecast[15]}: <br/> 
            High: {forecast[16]} {'\u00b0'}F<br/>
            Low: {forecast[16]} {'\u00b0'}F<br/>
            Conditions: <br/>
                <img className="weatherIcon" src={
                    "http://openweathermap.org/img/wn/" + forecast[18] + "@2x.png"
                    } alt="weather icon"></img><br/>
                {forecast[17]}</div>
        <div className="foreDay5">For {forecast[20]}: <br/> 
            High: {forecast[21]} {'\u00b0'}F<br/>
            Low: {forecast[21]} {'\u00b0'}F<br/>
            Conditions: <br/>
                <img className="weatherIcon" src={
                    "http://openweathermap.org/img/wn/" + forecast[23] + "@2x.png"
                } alt="weather icon"></img><br/>
                {forecast[22]}</div>
    </div>
)
